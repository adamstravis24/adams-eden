  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        ...
        'soft-lg': '0 4px 12px rgba(0, 0, 0, 0.05), 0 8px 24px rgba(0, 0, 0, 0.06)',
        'soft-xl': '0 8px 20px rgba(0, 0, 0, 0.06), 0 12px 32px rgba(0, 0, 0, 0.08)',
        'inner-soft': 'inset 0 2px 4px 0 rgba(0, 0, 0, 0.04)',
        'glow-primary': '0 0 20px rgba(22, 163, 74, 0.2)',
      },
      backgroundImage: {
