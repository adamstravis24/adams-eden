...
const SHOP_CATEGORIES = [
  ...
  },
  {
    name: "Outdoor Plants",
    slug: "outdoor-plants",
    description: "Perennials, annuals & garden favorites",
    icon: "🌿",
  ...
  },
  {
    name: "Herbs & Edibles",
    slug: "herbs-edibles",
    description: "Fresh herbs and kitchen garden staples",
    icon: "🌱",
  ...
  },
  {
    name: "Lighting",
    slug: "lighting",
    description: "Grow lights for indoor gardens",
    icon: "💡",
  ...
  },
  {
    ...
    description: "Premium potting mixes & nutrients",
    icon: "🪨",
